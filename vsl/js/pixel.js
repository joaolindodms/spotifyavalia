(() => {
    ...
    var t = {
                ...
                e.AppStorage = class {
                    ...
                    static getFbc() {
                        ...
                        for (const e of t) {
                            ...
                            if ("_fbc" === t) return decodeURIComponent(n)
                        }
                    }
                    static getFbp() {
                        var t;
            ...
            75: (t, e) => {
                ...
                class n {
                    constructor(t) {
                        this.version = "fb", this.fbclid = t, this.subdomainIndex = 0, this.creationTime = Date.now()
                    }
                    static fromClid(t) {
                ...
                class h {
                    ...
                    static tryFill(t) {
                        ...
                        return r(this, void 0, void 0, (function*() {
                            const r = yield p.Tracker.getTruthyLead(), a = h.classifyInput(t);
                            a === s.InputType.Phone && (t.value = null !== (e = r.phone) && void 0 !== e ? e : ""), a === s.InputType.Email && (t.value = null !== (n = r.email) && void 0 !== n ? n : ""), a === s.InputType.Name && (t.value = `${null!==(i=r.firstName)&&void 0!==i?i:""} ${null!==(o=r.lastName)&&void 0!==o?o:""}`)
                        }))
                    }
                    static handleInput(t) {
                        return r(this, void 0, void 0, (function*() {
                            const e = t.target,
                                n = h.classifyInput(e),
                                i = yield p.Tracker.getTruthyLead();
                            if (n === s.InputType.Phone) {
                                const t = yield c.CountryService.getCountry(i), n = u.Phone.format(e.value, "BR" === t);
                                l.AppStorage.save(p.Tracker.leadKey, Object.assign(Object.assign({}, i), {
                                    phone: n
                                }))
                            }
                            if (n === s.InputType.Email && l.AppStorage.save(p.Tracker.leadKey, Object.assign(Object.assign({}, i), {
                                    email: e.value
                                })), n === s.InputType.Name) {
            ...
            8: function(t, e) {
                ...
                class i {
                    static getIpv4(t) {
                        return n(this, void 0, void 0, (function*() {
                            return yield i.fetchIp("https://api.ipify.org?format=json", "error on getIpv4", null == t ? void 0 : t.timeoutMs)
                        }))
                    }
                    static getIpv6(t) {
                        return n(this, void 0, void 0, (function*() {
                            return yield i.fetchIp("https://api6.ipify.org?format=json", "error on getIpv6", null == t ? void 0 : t.timeoutMs)
                        }))
                    }
                    static fetchIp(t, e, i) {
                        var o;
                        return n(this, void 0, void 0, (function*() {
                            const n = i ? AbortSignal.timeout(i) : null;
                            try {
            ...
            774: function(t, e, n) {
                ...
                class d {
                    static init() {
                        this.inited || (this.inited = !0, d.monitorWindowOpen(), d.monitorLinks(!0), d.monitorButtons(!0), d.monitorForms(!0), new s.Observer({
                            throttle: 2e3,
                            groupEvents: !0
                        }).observeNewElements(document.body, (() => {
                    ...
                    static monitorButtons(t) {
                        ...
                        console.log("buttons", e), e.forEach((e => {
                            (t || this.canUseEl(e)) && e.addEventListener("click", (t => {
                                var n, i, o, r;
                                console.log("button clicked pixel", e), (d.isCheckoutButtonText(null !== (n = e.textContent) && void 0 !== n ? n : "") || d.isCheckoutButtonClassList(null !== (i = e.classList) && void 0 !== i ? i : "")) && (console.log("tracking ic with button", e), l.Tracker.track("InitiateCheckout")), d.isLeadButtonText(null !== (o = e.textContent) && void 0 !== o ? o : "") && (console.log("tracking lead with button", e), l.Tracker.track("Lead")), d.isAddToCartButtonText(null !== (r = e.textContent) && void 0 !== r ? r : "") && (console.log("tracking add to cart with button", e), l.Tracker.track("AddToCart"))
                            }), !0)
                        }))
                    }
                    static monitorForms(t) {
                        Array.from(document.querySelectorAll("form")).forEach((e => {
                            (t || this.canUseEl(e)) && e.addEventListener("submit", (t => {
                                ...
                                console.log("submitButton", a), d.isCheckoutButtonText(null !== (n = null == a ? void 0 : a.textContent) && void 0 !== n ? n : "") && (console.log("tracking ic with form", e), l.Tracker.track("InitiateCheckout")), d.isCheckoutButtonClassList(null !== (i = null == a ? void 0 : a.classList) && void 0 !== i ? i : null) && (console.log("tracking ic with form", e), l.Tracker.track("InitiateCheckout")), d.isCheckoutLink(e.action, void 0, void 0) && (console.log("tracking ic with form", e), l.Tracker.track("InitiateCheckout")), d.isLeadButtonText(null !== (o = null == a ? void 0 : a.textContent) && void 0 !== o ? o : "") && (console.log("tracking lead with button", a), l.Tracker.track("Lead")), d.isAddToCartButtonText(null !== (r = null == a ? void 0 : a.textContent) && void 0 !== r ? r : "") && (console.log("tracking add to cart with button", a), l.Tracker.track("AddToCart"))
                            }), !0)
                        }))
                    }
                    static monitorWindowOpen() {
                        ...
                        window.open = function(e, n, i) {
                            const o = () => t(e, n || "", i || "");
                            return d.isCheckoutLink(null == e ? void 0 : e.toString(), void 0, void 0) ? (l.Tracker.track("InitiateCheckout").finally((() => {
                                o()
                            })), null) : o()
                        }
                    }
                    static monitorLinks(t) {
                        Array.from(document.querySelectorAll("a")).forEach((e => {
                            (t || this.canUseEl(e)) && e.addEventListener("click", (t => {
                                ...
                                console.log("canSendIc", r), r && d.waitBeforeAction(t, l.Tracker.track("InitiateCheckout"), e);
                                const a = d.isLeadButtonText(null !== (i = e.textContent) && void 0 !== i ? i : "");
                                console.log("canSendLead", a), a && d.waitBeforeAction(t, l.Tracker.track("Lead"), e);
                                const s = d.isAddToCartButtonText(null !== (o = e.textContent) && void 0 !== o ? o : "");
                                console.log("canAddToCart", s), s && (console.log("tracking add to cart with button", e), d.waitBeforeAction(t, l.Tracker.track("AddToCart"), e))
                            }), !0)
                        }))
                    }
                    static waitBeforeAction(t, e, n) {
                        ...
                        return r(this, void 0, void 0, (function*() {
                            ...
                            if (d.isElementorButton(n)) return void(yield e);
                            if (null !== (i = null == t ? void 0 : t.flagged) && void 0 !== i && i) return void console.log("flagged event", t);
                            ...
                            console.log("target", n), console.log("insance of a el", n instanceof HTMLAnchorElement);
                            const a = n.classList.contains("link_interno");
                            if (r) r.call(n);
                            else if (n instanceof HTMLAnchorElement && null != n.href && "" !== n.href && !a) console.log("TARGET.href", n.href), window.location.href = n.href;
                            else if (n instanceof HTMLButtonElement && "submit" === n.type) {
                                const t = n.closest("form");
                                t && t.submit()
                            }
                            const s = new Event(t.type, t);
                            s.flagged = !0, null === (o = t.target) || void 0 === o || o.dispatchEvent(s), console.log("dispatched event", s), n.onclick = r
                        }))
                    }
                    static canUseEl(t) {
                    ...
                    static isCheckoutLink(t, n, i) {
                        ...
                        const s = l.Tracker.getTruthyLead();
                        if (s.icURLMatch) return null !== (o = null == t ? void 0 : t.includes(s.icURLMatch)) && void 0 !== o && o;
                        if (null != s.icTextMatch) {
                            if (null == n ? void 0 : n.includes(s.icTextMatch)) return !0;
                            const t = d.removeInvisibleCharsFromText(n);
                            return null !== (r = null == t ? void 0 : t.includes(s.icTextMatch)) && void 0 !== r && r
                        }
                        if (s.icCSSMatch) return null !== (a = null == i ? void 0 : i.contains(s.icCSSMatch)) && void 0 !== a && a;
                        for (const n of e.checkoutLinkKeywords)
                            if (null == t ? void 0 : t.toLowerCase().includes(n.toLowerCase())) return !0;
                        return !1
                    }
                    static isCheckoutButtonText(t) {
                        var n;
                        console.log("check can iniate checkout: ", t);
                        const i = l.Tracker.getTruthyLead();
                        if (null != i.icTextMatch) {
                            if (null == t ? void 0 : t.includes(i.icTextMatch)) return !0;
                            const e = d.removeInvisibleCharsFromText(t);
                            return null !== (n = null == e ? void 0 : e.includes(i.icTextMatch)) && void 0 !== n && n
                        }
                        return e.checkoutButtonKeywors.some((e => t.toLowerCase().includes(e)))
                    }
                    static isCheckoutButtonClassList(t) {
                        var e;
                        const n = l.Tracker.getTruthyLead();
            ...
            562: (t, e) => {
                Object.defineProperty(e, "__esModule", {
                    ...
                    constructor(t) {
                        var e, n;
                        this.mutations = [], this.timer = null, this.setThrottle(null !== (e = t.throttle) && void 0 !== e ? e : 100), this.groupEvents = null !== (n = t.groupEvents) && void 0 !== n && n
                    }
            ...
            554: (t, e) => {
                Object.defineProperty(e, "__esModule", {
                    ...
                    static format(t, e = !0) {
                        ...
                        let i = n;
                        const o = e ? "55" : "";
                        return e && (n.startsWith("00") ? i = n.substring(2) : n.startsWith("0") && (i = n.substring(1)), 10 === i.length ? i = `55${i.substring(0,2)}9${i.substring(2)}` : 12 === i.length && i.startsWith("55") && (i = `55${i.substring(0,4)}9${i.substring(4)}`)), i.startsWith(o) || (i = `${o}${i}`), i.replace(/^0+/, "")
                    }
                }
            },
            428: function(t, e, n) {
                ...
                class u {
                    static init(t) {
                        return r(this, void 0, void 0, (function*() {
                            var e, n, i, o, a, s;
                            "undefined" == typeof fbq && (e = window, n = document, i = "script", e.fbq || (o = e.fbq = function() {
                                o.callMethod ? o.callMethod.apply(o, arguments) : o.queue.push(arguments)
                            }, e._fbq || (e._fbq = o), o.push = o, o.loaded = !0, o.version = "2.0", o.queue = [], (a = n.createElement(i)).async = !0, a.src = "https://connect.facebook.net/en_US/fbevents.js", null == (s = n.getElementsByTagName(i)[0]) || s.parentNode.insertBefore(a, s))), t && t.length > 0 && (yield Promise.all(t.map((t => r(this, void 0, void 0, (function*() {
                    ...
                    static event(t) {
                        ...
                        return r(this, void 0, void 0, (function*() {
                            ...
                            if (console.log(`response for ${null===(e=t.lead)||void 0===e?void 0:e.pixelId}: ${null===(n=null==f?void 0:f.lead)||void 0===n?void 0:n.metaPixelIds}`), null == f.lead._id) return null;
                            const y = new l.Lead({
                                _id: f.lead._id,
                                pixelId: f.lead.pixelId,
                                userAgent: f.lead.userAgent,
                                birthdate: f.lead.birthdate,
                                email: f.lead.email,
                                fbc: f.lead.fbc,
                                fbp: f.lead.fbp,
                                firstName: f.lead.firstName,
                                geolocation: f.lead.geolocation,
                                ip: f.lead.ip,
                                ipv6: f.lead.ipv6,
                                lastName: f.lead.lastName,
                                metaPixelIds: f.lead.metaPixelIds,
                                phone: f.lead.phone,
                                parameters: f.lead.parameters,
                                updatedAt: new Date,
                                icTextMatch: null !== (i = f.icTextMatch) && void 0 !== i ? i : null,
                                icCSSMatch: null !== (o = f.icCSSMatch) && void 0 !== o ? o : null,
                                ipConfiguration: f.ipConfiguration,
                                leadTextMatch: null !== (a = f.leadTextMatch) && void 0 !== a ? a : null,
                                icURLMatch: null !== (s = f.icURLMatch) && void 0 !== s ? s : null,
                                addToCartTextMatch: null !== (c = f.addToCartTextMatch) && void 0 !== c ? c : null
                            });
                            return "PageView" === t.type && (yield this.init(y.metaPixelIds)), (null !== (u = null === (d = y.metaPixelIds) || void 0 === d ? void 0 : d.length) && void 0 !== u ? u : 0) > 0 && this.metaEvent(Object.assign(Object.assign({}, t), {
                                event: {
                                    _id: f.event._id,
                                    pageTitle: null !== (v = null === (p = t.event) || void 0 === p ? void 0 : p.pageTitle) && void 0 !== v ? v : null,
                                    sourceUrl: null !== (g = null === (h = t.event) || void 0 === h ? void 0 : h.sourceUrl) && void 0 !== g ? g : null
                                }
                            })), y
                        }))
                    }
                    ...
                    static getClientIpAddress(t, e, n) {
                        return r(this, void 0, void 0, (function*() {
                            switch (n) {
                                case s.IpConfigurationTypes.IPV6_ONLY:
                                    return t;
                                case s.IpConfigurationTypes.IPV6_OR_IPV4:
                                    return t || e;
                                case s.IpConfigurationTypes.NO_IP:
                                    return;
                                default:
                                    return t || e
                            }
                    ...
                    static metaEvent(t) {
                        var e, n, i, o, a, s, l, u, p, v, h, g, f, y, m, b, T, w, k, C, _, L, x, I;
                        return r(this, void 0, void 0, (function*() {
                            const r = c.StringUtils.removeAllNonAlphaChars(null !== (i = null === (n = null === (e = t.lead) || void 0 === e ? void 0 : e.geolocation) || void 0 === n ? void 0 : n.city) && void 0 !== i ? i : void 0),
                                F = c.StringUtils.removeAllNonAlphaChars(null !== (s = null === (a = null === (o = t.lead) || void 0 === o ? void 0 : o.geolocation) || void 0 === a ? void 0 : a.state) && void 0 !== s ? s : void 0),
                                M = c.StringUtils.removeAllNonAlhaNumericChars(null !== (p = null === (u = null === (l = t.lead) || void 0 === l ? void 0 : l.geolocation) || void 0 === u ? void 0 : u.zipcode) && void 0 !== p ? p : void 0),
                                P = c.StringUtils.removeAllNonAlphaAccentChars(null === (v = t.lead) || void 0 === v ? void 0 : v.firstName),
                            ...
                            fbq("track", t.type, {
                                ...
                                ct: yield d.Utils.hashValue(r), st: yield d.Utils.hashValue(F), zp: yield d.Utils.hashValue(M), client_user_agent: null === (m = t.lead) || void 0 === m ? void 0 : m.userAgent, client_ip_address: O, country: yield d.Utils.hashValue(null !== (w = null === (T = null === (b = t.lead) || void 0 === b ? void 0 : b.geolocation) || void 0 === T ? void 0 : T.country) && void 0 !== w ? w : void 0), external_id: null === (k = t.lead) || void 0 === k ? void 0 : k._id, fn: yield d.Utils.hashValue(P), ln: yield d.Utils.hashValue(S), em: yield d.Utils.hashValue(null === (C = null == t ? void 0 : t.lead) || void 0 === C ? void 0 : C.email), ph: yield d.Utils.hashValue(null === (_ = null == t ? void 0 : t.lead) || void 0 === _ ? void 0 : _.phone), fbc: null === (L = t.lead) || void 0 === L ? void 0 : L.fbc, fbp: null === (x = t.lead) || void 0 === x ? void 0 : x.fbp, content_type: "product", page_title: document.title
                            }, {
                ...
                u.initedPixels = [], i([a.visibleForTesting, o("design:type", Function), o("design:paramtypes", [Object, Object, Object]), o("design:returntype", Promise)], u, "getClientIpAddress", null), i([a.visibleForTesting, o("design:type", Function), o("design:paramtypes", [Object]), o("design:returntype", Promise)], u, "metaEvent", null), e.PixelUtmify = u
            },
            792: (t, e) => {
                Object.defineProperty(e, "__esModule", {
                    value: !0
                ...
                class g {
                    ...
                    static init(t) {
                        return r(this, void 0, void 0, (function*() {
                            ...
                            const [e, n] = yield Promise.all([u.Ips.getIpv4({
                                timeoutMs: 5e3
                            }), u.Ips.getIpv6({
                                timeoutMs: 5e3
                            })]);
                    ...
                    static trySendFbp() {
                        return r(this, void 0, void 0, (function*() {
                            const t = () => r(this, void 0, void 0, (function*() {
                                ...
                                (null == t ? void 0 : t._id) && t.fbp && (yield v.PixelUtmify.updateLead({
                                    _id: t._id,
                                    fbp: t.fbp
                                })) && l.AppStorage.save(g.leadKey, t)
                            }));
                    ...
                    static track(t) {
                        return r(this, void 0, void 0, (function*() {
                            ...
                            const e = this.getTruthyLead(),
                                n = yield v.PixelUtmify.event({
                                    type: t,
                                    lead: e,
                                    event: this.getEventData()
                                });
                            l.AppStorage.save(this.leadKey, n)
                        }))
                    }
                    ...
                    static getLeadFromLocalStorageOrNew() {
                        return l.AppStorage.load(this.leadKey) || new s.Lead({
                    ...
                    static getFbc(t) {
                        ...
                        if (o) return o;
                        return l.AppStorage.getFbc() || o
                    }
                    static getFbp(t) {
                        return t.fbp ? t.fbp : l.AppStorage.getFbp()
                    }
                    static getGclid(t) {
                        var e;
                    ...
                    static hashValue(t) {
                        return n(this, void 0, void 0, (function*() {
                            if (t && t.length) {
                                ...
                                return sha256 || (yield i.loadScript("https://cdn.jsdelivr.net/npm/js-sha256/src/sha256.min.js")), sha256(t)
                            }
                        }))
                    }
                    static loadScript(t) {
                        return n(this, void 0, void 0, (function*() {
                            return new Promise(((e, n) => {
                                ...
                                i.src = t, i.onload = e, i.onerror = n, document.head.appendChild(i)
                            }))
                        }))
                    }
                    static wait(t) {
            ...
            436: function(t, e, n) {
                ...
                class c {
                    ...
                    static trackByTime() {
                        return r(this, void 0, void 0, (function*() {
                            yield l.Utils.wait(8e3), s.Tracker.track("ViewContent")
                        }))
                    }
                    static trackByScroll() {
                        return r(this, void 0, void 0, (function*() {
                            window.addEventListener("scroll", (() => r(this, void 0, void 0, (function*() {
                                console.log("scrolling", window.scrollY), window.scrollY > 100 && s.Tracker.track("ViewContent")
                            }))))
                        }))
                    }
                }
                i([a.visibleForTesting, o("design:type", Function), o("design:paramtypes", []), o("design:returntype", Promise)], c, "trackByTime", null), i([a.visibleForTesting, o("design:type", Function), o("design:paramtypes", []), o("design:returntype", Promise)], c, "trackByScroll", null), e.ViewContentListener = c
            },
            119: (t, e) => {
                var n;
                Object.defineProperty(e, "__esModule", {
                    value: !0
                }), e.InputType = void 0, (n = e.InputType || (e.InputType = {})).Name = "Name", n.Email = "Email", n.Phone = "Phone", n.Unknown = "Unknown"
            },
            425: (t, e) => {
                var n;
                Object.defineProperty(e, "__esModule", {
                    value: !0
                }), e.IpConfigurationTypes = void 0, (n = e.IpConfigurationTypes || (e.IpConfigurationTypes = {})).IPV6_ONLY = "IPV6_ONLY", n.IPV6_OR_IPV4 = "IPV6_OR_IPV4", n.NO_IP = "NO_IP"
            },
            937: (t, e) => {
                Object.defineProperty(e, "__esModule", {
                    value: !0
